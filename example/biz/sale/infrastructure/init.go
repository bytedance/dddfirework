...
import (
	...
	"github.com/bytedance/dddfirework/executor/db"
)

func Init() {
	db.RegisterEntity2Model(&domain.Order{}, func(entity, parent ddd.IEntity, op ddd.OpType) (db.IModel, error) {
		...
		return m, nil
	}, func(m db.IModel, do ddd.IEntity) error {
	...
	db.RegisterEntity2Model(&domain.SaleItem{}, func(entity, parent ddd.IEntity, op ddd.OpType) (db.IModel, error) {
	...
	db.RegisterEntity2Model(&domain.Coupon{}, func(entity, parent ddd.IEntity, op ddd.OpType) (db.IModel, error) {
